import { ActionIcon, Anchor, Button, Center, Divider, SimpleGrid, Text, TextInput } from '@mantine/core';
    ...
    <>
      ...
      <SimpleGrid cols={2} spacing="xs">
        <TextInput
          ...
          rightSection={
            <ActionIcon component="a" href={`tel:${event.phone}`} color="fr-yellow.3" m="xs" p="xs" variant="subtle">
              <IconPhone size="1rem" />
            </ActionIcon>
          }
        />
        <TextInput
          ...
          rightSection={
            <ActionIcon component="a" href={`mailto:${event.email}`} color="fr-yellow.3" m="xs" p="xs" variant="subtle">
              <IconSend size="1rem" />
            </ActionIcon>
          }
        />
