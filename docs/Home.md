...
Dans Helix, vous pouvez gérer vos patients, leurs rendez-vous, leurs factures et votre comptabilité, leurs dossiers
médicaux, etc.
...
Post Logout URL: `http://localhost:3000/login`